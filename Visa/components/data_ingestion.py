...
class DataIngestion:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            us_visa_dataframe[COLUMNS_COMPANY_AGE] = current_year-us_visa_dataframe[COLUMNS_YEAR_ESTB]
            
            us_visa_dataframe.drop([COLUMN_ID,COLUMNS_YEAR_ESTB], axis=1, inplace=True)
